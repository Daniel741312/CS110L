...
impl Process {
    ...
    pub fn print(&self) {
        ...
        // self.list_fds();
        if let Some(open_files) = self.list_open_files() {
            ...
            println!("Warning: could not inspect file descriptors for this process!\
                        It might have exited just as we were about to look at its fd table,\
                        or it might have exited a while age and is waiting for the parent to reap it.
                    ");
        }
    }
